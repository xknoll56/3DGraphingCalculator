...
namespace OpenTKCalculator
{
    public partial class MainForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Entity entity2 = new Entity(new Vector3(0, 2.5f, 0), new Vector3(0.35f, 5, 0.35f), new Quaternion(new Vector3(0, 0, 0)));
            entity2.mesh = mesh;
            entity2.color = new Vector3(0, 1, 0);
            unitDirs.AddChild(entity2);

            Entity entity3 = new Entity(new Vector3(2.5f, 0, 0), new Vector3(0.35f, 5, 0.35f), new Quaternion(new Vector3(0, 0, (float)Math.PI * 0.5f)));
            entity3.mesh = mesh;
